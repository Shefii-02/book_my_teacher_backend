...
@section('nav-options')
    <nav>
        ...
        <h6 class="mb-0 font-bold text-white">Workshop Registrations Listing</h6>
    </nav>
@endsection
            ...
            <div class="p-6 pb-2 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <div class="flex">
                    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                        <h6 class="dark:text-white">Workshop Registrations</h6>
                    </div>
                    <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full px-3 sm:w-1/2 xl:w-1/4 mb-4">
                <div class="bg-white shadow rounded-xl p-4">
                    ...
                    <h4 class="font-bold">{{ $data['total_workshop'] ?? 0 }}</h4>
                </div>
            </div>
            ...
            <div class="w-full px-3 sm:w-1/2 xl:w-1/4 mb-4">
                <div class="bg-white shadow rounded-xl p-4">
                    <p class="text-sm">Unconfirmed</p>
                    <h4 class="font-bold">{{ $data['in_active'] ?? 0 }}</h4>
                </div>
            </div>
            ...
            <div class="w-full px-3 sm:w-1/2 xl:w-1/4 mb-4">
                <div class="bg-white shadow rounded-xl p-4">
                    ...
                    <h4 class="font-bold">{{ $data['removed'] ?? 0 }}</h4>
                </div>
            </div>
