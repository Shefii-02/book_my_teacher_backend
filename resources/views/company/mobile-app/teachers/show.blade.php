                    ...
                    <div class="row g-4 ">
                        ...
                        <div class="col-lg-3">
                            <div class="metric-card success">
                                ...
                                <h3>{{ $teacher->user->total_spend_hours ?? 0 }} hrs</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="metric-card info">
                                ...
                                <h3>{{ $teacher->user->courses_launched->count() ?? 0 }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="metric-card warning">
                                <p>Green Coins</p>
                                <h3>₹{{ number_format($teacher->user->wallet_green_coin_total_earning ?? 0) }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="metric-card warning">
                                <p>Total Classes</p>
                                <h3>₹{{ number_format($teacher->user->wallet_rupees_total_earning ?? 0) }}</h3>
                            </div>
                        </div>
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="metric-card success">
                            ...
                            <h4 class="text-success">₹{{ number_format($teacher->wallet_rupees_total_earning) }}</h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="metric-card success">
                            <p>Total Green Coin Earnings</p>
                            <h4 class="text-success">{{ $teacher->wallet_green_coin_total ?? 0 }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="metric-card warning">
                            ...
                            <h4 class="text-primary">₹{{ number_format($teacher->wallet?->balance) }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="metric-card danger">
                            <p>Total Withdrawn</p>
                            <h4 class="text-danger">₹{{ number_format($teacher->wallet_rupees_withdrawn) }}</h4>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="payments">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="wallet-card">
                            <p>Total Paid</p>
                            <h4 class="text-success">₹{{ number_format($paymentsSummary->total_paid ?? 0) }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="wallet-card">
                            <p>Pending Payout</p>
                            <h4 class="text-warning">₹{{ number_format($paymentsSummary->pending ?? 0) }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="wallet-card">
                            <p>Failed Payments</p>
                            <h4 class="text-danger">₹{{ number_format($paymentsSummary->failed ?? 0) }}</h4>
                        </div>
                    </div>
