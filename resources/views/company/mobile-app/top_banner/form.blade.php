    ...
    <nav>
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li
                ...
                Top Banners {{ isset($banner) ? 'Edit' : 'Create' }}
            </li>
        </ol>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class=" mb-6 courseSection" style="display:none">
                                ...
                                <select name="course_id" class="pl-3 text-sm w-full bannerSection rounded-lg border border-gray-300 py-2">
                                    <option value="">Select Course</option>
                                    @foreach ($courses as $course)
                                        <option {{ isset($banner) && $banner->type == 'course' && $banner->section_id == $course->id ? 'selected' : '' }}  value="{{ $course->id }}">{{ $course->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class=" mb-6 workshopSection" style="display:none">
                                ...
                                <select name="workshop_id"
                                    ...
                                    @foreach ($workshops as $workshop)
                                        <option {{ isset($banner) &&  $banner->type == 'workshop' && $banner->section_id == $workshop->id ? 'selected' : '' }} value="{{ $workshop->id }}">{{ $workshop->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class=" mb-6 webinarSection" style="display:none">
                                ...
                                <select name="webinar_id"
                                    ...
                                    @foreach ($webinars as $webinar)
                                        <option {{ isset($banner) &&  $banner->type == 'webinar' && $banner->section_id == $webinar->id ? 'selected' : '' }} value="{{ $webinar->id }}">{{ $webinar->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
