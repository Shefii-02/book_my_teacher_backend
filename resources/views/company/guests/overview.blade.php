    ...
    <nav>
        ...
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2  font-bold capitalize  text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                aria-current="page">Guest Overview</li>
        </ol>
        <h6 class="mb-0 font-bold text-white capitalize">Guest Overview</h6>
    </nav>
@endsection
@section('content')
    <div class="container">
    ...
    <div class="w-full px-6 py-4 mx-auto">
        <div class="bg-white dark:bg-slate-850 shadow-xl rounded-2xl p-6 mb-6">
            ...
            <img src="{{ $guest->avatar_url }}" class="w-20 rounded-lg mb-5">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">

                <p><span class="font-semibold">Full Name:</span> <span
                        class="capitalize font-bold">{{ $guest->name }}</span></p>
                <p><span class="font-semibold">Email:</span> <span class="capitalize font-bold">{{ $guest->email }}</span>
                </p>
                <p><span class="font-semibold">Phone:</span> <span
                        class="capitalize font-bold">{{ $guest->mobile }}</span></p>
