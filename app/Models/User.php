...
class User extends Authenticatable
{
  ...
  {
    return $this->avatar && file_exists(storage_path('app/' . $this->avatar->file_path)) ? asset('storage/' . $this->avatar->file_path) : 'https://ui-avatars.com/api/?name=' . urlencode($this->name);
  }
