...
Route::group(['namespace' => 'App\Http\Controllers\Api', 'prifix' => 'api'], function () {
  ...
  Route::post('/apple-sign-in', 'LoginController@AppleLoginCheck');
  ...
  Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('finding-teacher-request-form/submit', 'RequestController@findingTeachers');
    ...
    Route::post('/today-classes', 'UserController@todayClasses');
    ...
    Route::post('/teacher/webinar-details', 'TeacherController@webinarDetails');
    ...
    Route::post('/teacher/course/class/update', 'TeacherController@courseClassUpdate');
    Route::post('/teacher/course/class/delete', 'TeacherController@courseClassDelete');
    Route::post('/teacher/course/material/delete', 'TeacherController@courseMaterialDelete');
    ...
    Route::post('/teacher/watch-time', 'TeacherController@watchTime');
