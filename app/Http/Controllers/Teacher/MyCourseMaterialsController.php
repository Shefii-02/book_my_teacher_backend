...
class MyCourseMaterialsController extends Controller
{
  public function index($courseId)
  {
    ...
    return view('teacher.my_courses.materials.index', compact('course', 'materials'));
  }

  public function create($courseId)
  {
    $course = Course::where('course_identity', $courseId)->first() ?? abort(404);
    return view('teacher.my_courses.materials.form', compact('course'));
  }
  ...
  public function store(Request $request, $courseId)
  {
    ...
    return redirect()->route('teacher.my-courses.materials.index', $course->course_identity)->with('success', 'Material added successfully!');
  }
  ...
  public function edit($courseId, $id)
  {
    ...
    return view('teacher.my_courses.materials.form', compact('course', 'material'));
  }
