                ...
                <div class="flex flex-wrap -mx-3">
                    <div
                        ...
                        <div
                            ...
                            <img src="/assets/images/logo/BookMyTeacher-black.png" class=" mb-4" alt="main_logo" />
                            ...
                            <div
                                ...
                                <p class="mx-auto mb-6 leading-normal text-sm">Don't have an account?
                                    <a href="https://wa.me/917510115544?text=Hello%20Team%2C%0ACould%20you%20help%20me%20with%20an%20account%20for%20Bookmyteacher"
                                        target="_blank"
                                        class="font-semibold text-transparent bg-clip-text bg-gradient-to-tl from-emerald-500 to-violet-500">Sign
                                        up</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div style="background: url('/assets/images/bg/team.jpg');background-position: center;background-size: cover;"
                            class="relative flex flex-col justify-center h-full bg-cover px-24 m-4 overflow-hidden rounded-xl bg-[url('/assets/images/bg/team.jpg')] bg-center bg-cover">
                            <span
                                class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-slate-600  opacity-60"></span>
                            <h4 class="z-20 mt-18 font-bold text-white">"Attention is the new Way"</h4>
