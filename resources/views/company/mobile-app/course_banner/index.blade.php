                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-3 border-b border-transparent rounded-t-2xl">
                        <div class="flex justify-between">
                            ...
                            <a href="{{ route('admin.app.course-banners.create') }}"
                                        ...
                                        <td
                                            ...
                                            <div id="dropdownBottom_{{ $key }}"
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.app.course-banners.edit', $banner->id) }}"
                                                    ...
                                                    <li>
                                                        <form id="form_{{ $banner->id }}" class="m-0 p-0"
                                                            action="{{ route('admin.app.course-banners.destroy', $banner->id) }}"
