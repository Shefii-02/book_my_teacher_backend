                                ...
                                <tbody>
                                    @foreach ($webinars as $key => $webinar)
                                        <tr>
                                                ...
                                                <div class="flex items-center">
                                                    @if ($webinar->thumbnail_image)
                                                        <img src="{{ asset('storage/' . $webinar->thumbnail_image) }}"
                                                            class="h-9 w-9 rounded-xl mr-2" alt="thumb">
                                                    @endif
                                                    <span
                                            ...
                                            <td
                                                class="p-2 text-sm leading-tight dark:text-white dark:opacity-80 text-slate-400">
                                                {{ $webinar->host?->name ?? 'N/A' }}</td>
                                            <td
                                                class="p-2 text-sm leading-tight dark:text-white dark:opacity-80 text-slate-400">
                                                {{ $webinar->provider?->name ?? 'N/A' }}</td>
                                            <td
                                                class="p-2 text-center text-sm leading-tight dark:text-white dark:opacity-80 text-slate-400">
                                            ...
                                            <td class="p-2 text-center">
                                                <span
                                                    class="{{ $statusColors[$webinar->status] ?? 'bg-gray-500' }} px-2.5 py-1.5 text-xs rounded text-white">{{ ucfirst($webinar->status) }}</span>
                                            </td>
                                            <td
