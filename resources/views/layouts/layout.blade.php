                ...
                <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav-test grow basis-full">
                    <ul class="flex flex-col pl-0 mb-0">
                        <li class="mt-0.5 w-full">
                            <a class="py-2.7  {{ Request::routeIs('admin.dashboard') ? 'bg-blue-500/13' : '' }} dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors"
                        ...
                        <li class="mt-0.5 w-full">
                            <a class="{{ Request::routeIs('admin.teachers') ? 'bg-blue-500/13' : '' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <li class="mt-0.5 w-full">
                            <a class=" dark:text-white {{ Request::routeIs('admin.students') ? 'bg-blue-500/13' : '' }} dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
