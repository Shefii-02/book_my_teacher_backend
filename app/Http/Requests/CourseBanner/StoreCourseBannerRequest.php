...
class StoreCourseBannerRequest extends FormRequest
{
  ...
  {
    return [
      'thumb_id'    => 'required|image|mimes:jpg,jpeg,png,webp|max:2048',
      'main_id'     => 'required|image|mimes:jpg,jpeg,png,webp|max:2048',
