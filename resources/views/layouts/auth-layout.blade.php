...
<head>
    ...
    <title>BookMyTeacher-SignIn Page</title>
    ...
    <!-- Main Styling -->
    <link
        href="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/css/argon-dashboard-tailwind.min.css?v=1.0.1"
        rel="stylesheet" />
                ...
                <div class="w-8/12 max-w-full px-3 mx-auto mt-1 text-center flex-0">
                  <p><a href="{{ url('privacy-policy') }}">Privacy Policy</a>|<a href="{{ url('terms-conditions') }}">Terms Conditions</a></p>
                    <p class="mb-0 text-slate-400">
                        ...
                        BOOK MY TEACHER EDUTECH PRIVATE LIMITED
                    </p>
                </div>
            </div>
        </div>
...
<script src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/js/plugins/perfect-scrollbar.min.js" async>
</script>
<!-- main script file  -->
<script src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/js/argon-dashboard-tailwind.min.js?v=1.0.1"
    async></script>
