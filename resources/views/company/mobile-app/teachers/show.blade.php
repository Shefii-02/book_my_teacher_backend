        ...
        <div class="student-header-premium m-5">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex align-items-center gap-4">
                    <img src="{{ $teacher->avatar_url ?? 'https://i.pravatar.cc/150' }}" class="avatar-xl">

                    <div>
                        <h3 class="fw-bold mb-1">{{ $teacher->name }}</h3>
                        <p class="text-muted mb-1">ID: {{ $teacher->referral_code }}</p>
                ...
                <div class="admin-actions">
                    ...
                    <span
                        class="badge {{ $teacher->status ? 'bg-success' : 'bg-danger' }}">{{ $teacher->status ? 'Active' : 'Deactive' }}</span>
                </div>
