                            ...
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p
                                        ...
                                        Total Referral</p>
                                    <h5 class="mb-2 font-bold dark:text-white">{{ $data['referral']['total'] }}</h5>
                            ...
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p
                                        ...
                                        Total Coins</p>
                                    <h5 class="mb-2 font-bold dark:text-white">{{ $data['coins']['total'] }}</h5>
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            ...
            <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                    ...
                    <!-- Control buttons -->
                    <button btn-next
                        class="absolute z-10 w-10 h-10 p-2 text-white border-none opacity-50 cursor-pointer text-lg hover:opacity-100 far fa-chevron-right active:scale-110 top-6 right-4"></button>
                    <button btn-prev
                        class="absolute z-10 w-10 h-10 p-2 text-white border-none opacity-50 cursor-pointer text-lg hover:opacity-100 far fa-chevron-left active:scale-110 top-6 right-16"></button>
                </div>
            </div>
        </div>
                ...
                <div
                    ...
                    <div class="p-4 pb-0 mb-0 rounded-t-4">
                        <div class="flex justify-between">
                            <h6 class="mb-2 dark:text-white">Visit Analystics</h6>
                        </div>
                    </div>
                              ...
                              {{--    <tr>
                                    <td
                                        ...
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/US.png"
                                                    alt="Country flag" />
                                            </div>
                                            <div class="ml-6">
                                                <p
                                ...
                                <tr>
                                    <td
                                        ...
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/DE.png"
                                                    alt="Country flag" />
                                            </div>
                                            <div class="ml-6">
                                                <p
                                ...
                                <tr>
                                    <td
                                        ...
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/GB.png"
                                                    alt="Country flag" />
                                            </div>
                                            <div class="ml-6">
                                                <p
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/BR.png"
                                                    alt="Country flag" />
                                            </div>
                                            <div class="ml-6">
                                                <p
            ...
            <div class="w-full max-w-full px-3 mt-0 lg:w-5/12 lg:flex-none">
                <div
                    ...
                    <div class="p-4 pb-0 rounded-t-4">
                        <h6 class="mb-0 dark:text-white">Top Search Teachers</h6>
                    </div>
                    <div class="flex-auto p-4">
