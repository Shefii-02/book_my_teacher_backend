...
<div class="form-body mt-3">
    ...
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-6 text-sm">
            ...
            <div>
                <p class="text-gray-500">Discount Validity : <span class="font-medium text-gray-900 text-green-700">{{ $course->discount_validity }}</span></p>
            ...
            <div>
                ...
                <p class="font-medium text-gray-900 text-green-700">₹{{ number_format($course->gross_price, 2) }}</p>
            </div>
            <div>
