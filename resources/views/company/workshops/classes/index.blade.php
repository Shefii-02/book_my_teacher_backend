    ...
    <nav>
        ...
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2  font-bold capitalize  text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                aria-current="page">Workshop Class's Listing</li>
        </ol>
        <h6 class="mb-0 font-bold text-white capitalize">Workshop Class's Listing</h6>
    </nav>
@endsection
@section('content')
    <!-- cards -->
                    ...
                    <div class="p-4 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex">
                            <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                                <h6 class="dark:text-white">Workshop : {{ $workshop->title }}</h6>
                            </div>
                            <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                            ...
                            <div class="w-full text-right max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-2/4 mb-3">
                                ...
                                <a href="#" data-url="{{ route('company.workshops.schedule-class.create', $workshop->id) }}"
                    ...
                    <div class="flex-none w-full max-w-full px-3">
                        <div
                            ...
                            <table
                                ...
                                <tbody>
                                    @forelse($workshop->classes ?? [] as $key => $class)
                                        @php
                                            $classLink =
                                                $class->recording_url == ''
                                                    ? $class->meeting_link
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a href="#" data-url="{{ route('company.workshops.schedule-class.edit', ['id' => $workshop->id, 'schedule_class' => $class->id]) }}"
                                                    class="open-drawer px-3 py-1 text-blue rounded text-xs">
                                                    <i class="bi bi-pencil"></i>
                                                </a>

                                                <form
                                                    action="{{ route('company.workshops.schedule-class.destroy', ['id' => $workshop->id, 'schedule_class' => $class->id]) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center p-5">No workshop classes found</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
