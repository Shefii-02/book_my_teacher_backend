  ...
  private function getDummyStatistics()
  {
    return [
      ...
      "watch" => [
        ...
        "Current Month" => [
          "Individual"   => $this->generateSeries(14, 2, 1),
          "Own Courses"  => $this->generateSeries(14, 2, 3),
          "YouTube"      => $this->generateSeries(14, 3, 8),
          "Workshops"    => $this->generateSeries(14, 1, 0),
          "Webinar"      => $this->generateSeries(14, 2, 4),
        ],
        "Last Month" => [
          "Individual"   => $this->generateSeries(30, 3, 1),
          "Own Courses"  => $this->generateSeries(30, 2, 2),
          "YouTube"      => $this->generateSeries(30, 3, 6),
          "Workshops"    => $this->generateSeries(30, 1, 9),
          "Webinar"      => $this->generateSeries(30, 2, 3),
        ],
      ],
    ];
  }
