    ...
    <nav>
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2 text-white before:float-left before:pr-2 before:text-white before:content-['/']">
                <a class="text-white" href="{{ route('admin.app.course-banners.index') }}">Course Banners List</a>
            </li>
            <li
...
@section('content')
    <div class="container">
        <div class="card bg-white rounded-3 my-3">
            <div class="card-title p-3 my-3">
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('admin.app.course-banners.index') }}"
        ...
        <div class="form-container bg-white shadow-xl rounded-2xl p-6">
            <form
                action="{{ isset($banner) ? route('admin.app.course-banners.update', $banner->id) : route('admin.app.course-banners.store') }}"
