...
class StoreTopBannerRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'thumb_id' => 'exclude_unless:type,other|required|image|mimes:jpg,jpeg,png,webp|max:2048',
      'main_id'  => 'exclude_unless:type,other|required|image|mimes:jpg,jpeg,png,webp|max:2048',
