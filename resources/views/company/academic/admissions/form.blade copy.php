            ...
            <form id="admissionForm" method="POST" action="{{ route('admin.admissions.store') }}">
                ...
                <div id="installmentBox" class="{{ old('is_installment') ? '' : 'hidden' }} mb-4 p-4 border rounded">
                    ...
                    <div class="mb-2 flex gap-2">
                        ...
                        <button type="button" id="resetInstallments" class="px-3 py-2 bg-gray-300 rounded">Reset</button>
                    </div>
                ...
                {{-- Price / tax / totals --}}
                <div class="flex flex-col gap-3 grid-cols-4 items-end mb-4 w-full">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" readonly disabled name="grand_total" id="grand_total"
                        ...
                        data.forEach(u => {
                            html +=
                                ...
                                <b>Course : ${u.title}</b><br><small>
                                  Price : ${u.net_price ||''} Hours : ${u.actual_price || ''}</small></div>`;
...
// #installments_count
            $(document).on('input change keyup', '#installment_additional_amount, #installment_interval_months', function() {
