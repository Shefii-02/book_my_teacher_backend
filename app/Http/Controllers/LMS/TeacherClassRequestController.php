...
class TeacherClassRequestController extends Controller
{
  ...
  {
    $query = TeacherClassRequest::with('user')->latest();
    ...
    $data = [
      'total' => [
        'teachers' => TeacherClassRequest::count()
      ],
      'unverified' => [
        'teachers' => TeacherClassRequest::where('status', '!=', 'converted_to_admission',)->where('status', '!=', 'closed')->count()
      ],
      'verified' => [
        'teachers' => TeacherClassRequest::where('status', 'converted_to_admission')->count()
      ],
      'rejected' => [
        'teachers' => TeacherClassRequest::where('status', 'closed')->count()
      ],
    ];

    return view('company.requests.teacher-class-requests', compact('requests', 'data'));
  }

  public function create(Request $request)
  {

    return view('company.requests.teacher-class-requests-create');
  }
